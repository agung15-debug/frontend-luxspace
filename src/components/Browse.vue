  ...
  <section class="flex bg-gray-100 py-16 px-4" id="browse-the-room">
    <div class="container mx-auto">
      <div class="flex flex-start mb-4">
        <h3 class="text-2xl capitalize font-semibold text-left">
      ...
      <div class="grid grid-rows-2 grid-cols-9 gap-4">
        ...
        >
          <div class="card-shadow rounded-xl">
            <img
              src="../assets/content/image-catalog-1.png"
              alt=""
              class="
                w-full
                h-full
        ...
        >
          <div class="card-shadow rounded-xl">
            <img
              src="../assets/content/image-catalog-3.png"
              alt=""
              class="
                w-full
                h-full
        ...
        >
          <div class="card-shadow rounded-xl">
            <img
              src="../assets/content/image-catalog-4.png"
              alt=""
              class="
                w-full
                h-full
        ...
        <div class="relative col-span-9 row-span-1 md:col-span-4 card">
          <div class="card-shadow rounded-xl">
            <img
              src="../assets/content/image-catalog-2.png"
              alt=""
              class="
                w-full
                h-full
